...
export type TranslationWhereInput = {
  ...
  locale?: Prisma.EnumLocaleFilter<"Translation"> | $Enums.Locale
...
export type TranslationScalarWhereWithAggregatesInput = {
  ...
  locale?: Prisma.EnumLocaleWithAggregatesFilter<"Translation"> | $Enums.Locale
...
export type TranslationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "locale" | "value" | "updatedAt", ExtArgs["result"]["translation"]>
...
export interface TranslationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const translationWithKeyOnly = await prisma.translation.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Translations and only return the `key`
   * const translationWithKeyOnly = await prisma.translation.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Translations and only return the `key`
   * const translationWithKeyOnly = await prisma.translation.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TranslationFieldRefs {
  ...
  readonly locale: Prisma.FieldRef<"Translation", 'Locale'>
