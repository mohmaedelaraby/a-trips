 ...
 *
 * lucide-react dropped its brand icons in v1, and a logo is the one place a
 * generic glyph will not do — a "share" arrow does not tell anyone which
 * network the link goes to. Paths are the Simple Icons outlines (CC0), drawn on
 * the usual 24×24 grid and filled with `currentColor` so they follow the link's
 * own colour and hover state.
 */
